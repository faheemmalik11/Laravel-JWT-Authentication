...
class AuthController extends Controller
{
    ...
    {
        $this->middleware('auth:api', ['except' => ['login']]); //auth middleware is applied to all the function except login. Check App\Http\Middleware\Authenticate.php for middleware
    }
